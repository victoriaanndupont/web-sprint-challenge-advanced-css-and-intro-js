...
1. How would you describe acessibility on the web to someone new to programming? Works at diffent browser sizes including cell phones.
2. Talk about 3 different things you can do to ensure your website is accessible. use Responsive design, use flexbox,
3. How would you explain the concept of a variable to someone new to programming? a form of named storage for data.
4. What is the purpose of using functions in code? a function allows you to create a self contained block of code, that you can reuse as many times as you want.
